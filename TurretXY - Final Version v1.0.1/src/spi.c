...
SPI_TypeDef *ACTIVE_SPI = SPI1; // Default to SPI1
...
// Used to confirm full SPI data transfer is complete (BSY flag bit is 0)
void waitForSPIReady(void)
{
    while (ACTIVE_SPI->SR & (1 << 7)) { 
        // while SPI is not ready, while loop
    }
}
